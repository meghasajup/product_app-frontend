      ...
      <Container>
        <Box margin={5}
          ...
          sx={{
            ...
            <Typography align='center' variant='h4' sx={{marginBottom: 5}}>Add Product</Typography>

            <form onSubmit={handleSubmit(onSubmit)}>
              <Grid container justifyContent={"center"} spacing={4} >

                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <TextField id="outlined-basic" sx={{ width: "100%" }} label='Title' {...register("title")} variant='outlined' />
                </Grid>

                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <TextField id="outlined-basic" sx={{ width: "100%" }} label='Category' {...register("category")} variant='outlined' />
                </Grid>

                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <TextField id="outlined-basic" sx={{ width: "100%" }} label='Description' {...register("description")} variant='outlined' />
                </Grid>

                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <TextField id="outlined-basic" sx={{ width: "100%" }} label='Quantity' {...register("quantity")} variant='outlined' />
                </Grid>

                <Grid item xs={12} sm={6} md={6} lg={6}>
                  <TextField id="outlined-basic" sx={{ width: "100%" }} label='Price' {...register("price")} variant='outlined' />
                </Grid>
                ...
                <Button variant="contained" sx={{ width: "30%", marginTop: 4, marginBottom: 4 }} type="submit">Add</Button>
